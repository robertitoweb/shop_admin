       ...
       <div className=' container'>
        <div className=' flex justify-between items-center'>
         ...
         <div className=' lg:flex hidden w-full max-w-[500px]'>
             <input className=' border-2 border-green-500 px-6
              py-2 w-full' type='text' 
              placeholder='Search for products...' />

              <div className='  bg-green-500 text-white text-[26px] 
         ...
         <div className=' flex gap-4 md:gap-8 items-center'>
            ...
            <div className=' txt-gray-500 text-[32px] relative cursor-pointer'
        ...
        <div className=' border-b border-gry-200 pt-4 ' />
